...
use application::ctftime::sanitize_channel_name;
use infrastructure::constants::{ACTIVE_CATEGORY, BUTTON_PREFIX_CREATE, BUTTON_PREFIX_JOIN};
...
pub async fn event_handler(
    ...
    _framework: poise::FrameworkContext<'_, application::HttpService, Error>,
    _data: &application::HttpService,
) -> Result<(), Error> {
